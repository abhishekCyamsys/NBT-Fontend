        ...
        {!registrationId ? (
          <>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <Link to="/visitor/login" className="inline-flex items-center justify-center rounded-lg bg-primary px-4 py-2 text-sm font-bold text-white shadow hover:bg-primary-dark">
                Login
              </Link>
            </div>
          </>
          ...
          <div className="rounded-xl border border-red-200 bg-red-50 p-4">
            ...
            <button onClick={() => navigate('/visitor/events')} className="mt-3 text-sm font-bold text-primary hover:underline">
              ⟵ Back to Events
            </button>
          </div>
        ) : data ? (
          <div className="space-y-6">
            ...
            {data.tickets.length === 0 || data.status === 'processing' || addingChild ? (
               <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in zoom-in-95 duration-500">
                 <div className="h-12 w-12 animate-spin rounded-full border-4 border-blue-100 border-t-primary mb-6" />
                ...
                {data.tickets.map((t) => (
                  <div id={`ticket-${t.ticketId}`} key={t.ticketId} className="relative mx-auto w-full max-w-sm overflow-hidden rounded-3xl bg-white shadow-xl border border-gray-100 transition hover:shadow-2xl">
                    ...
                    <div className="bg-white">
                      <div className="bg-gradient-to-br from-primary to-[#7a0230] p-6 text-white text-center">
                      ...
                      <div className="px-8 pb-8 pt-6 border-b-2 border-dashed border-gray-200">
                        ...
                        <div className="mt-6">
                          <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                            ...
                            <span className={`inline-flex rounded-md px-2 py-1 text-[10px] font-bold uppercase tracking-widest ${t.ticketType === 'child' ? 'bg-indigo-50 text-indigo-700' : 'bg-blue-50 text-primary'}`}>
                              {t.ticketType || 'Parent'}
                            </span>
                    ...
                    <div data-html2canvas-ignore="true" className="bg-gray-50/80 p-4 text-center">
                      <button onClick={() => downloadTicket(t.ticketId)} className="w-full justify-center text-sm font-bold text-primary hover:text-primary-dark transition inline-flex items-center gap-2">
            ...
            <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                ...
                <div key={index} className="space-y-3 rounded-xl border border-gray-100 bg-gray-50 p-3 pt-4 relative">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:border-primary focus:ring-2 focus:ring-blue-100 focus:outline-none transition-shadow"
                    />
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm focus:border-primary focus:ring-2 focus:ring-blue-100 focus:outline-none transition-shadow"
                    >
              ...
              {childPasses.length < 3 && (
                <button
                  ...
                  className="w-full rounded-xl border-2 border-dashed border-gray-200 py-3 text-sm font-semibold text-gray-500 hover:border-primary hover:text-primary transition-colors"
                >
                  + Add Another Child
                </button>
              )}
              ...
              <div className="flex gap-3 mt-6 pt-2">
                ...
                <button
                  ...
                  className="flex-1 rounded-xl bg-primary px-4 py-3 text-sm font-bold text-white hover:bg-primary-dark disabled:opacity-50 shadow-lg shadow-rose-200 transition-all"
                >
