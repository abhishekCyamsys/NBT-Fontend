  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto py-4">
      ...
      <div className="rounded-3xl border border-gray-100 bg-white shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-500">
        <div className="bg-gradient-to-r from-[#B30447] to-[#7a0230] px-6 py-10 sm:px-12 text-white flex flex-col sm:flex-row items-center sm:items-center gap-6 sm:gap-8">
          ...
          <div className="text-center sm:text-left flex-1 min-w-0">
            ...
            <p className="text-rose-100 font-medium tracking-wide mt-2 flex items-center justify-center sm:justify-start gap-2 text-sm sm:text-lg">
        ...
        <div className="p-6 sm:p-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-10 gap-x-12">
            <div className="space-y-2">
              <label className="text-xs font-bold text-rose-800 uppercase tracking-widest flex items-center gap-2">
                <div className="p-1.5 rounded bg-rose-50 text-[#B30447]"><User className="h-4 w-4" /></div>
                Full Name
              </label>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-rose-800 uppercase tracking-widest flex items-center gap-2">
                <div className="p-1.5 rounded bg-rose-50 text-[#B30447]"><Phone className="h-4 w-4" /></div>
                Mobile Number
              </label>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-rose-800 uppercase tracking-widest flex items-center gap-2">
                <div className="p-1.5 rounded bg-rose-50 text-[#B30447]"><Calendar className="h-4 w-4" /></div>
                Age Range
              </label>
            ...
            {city !== "Not Provided" && (
              <div className="space-y-2">
                <label className="text-xs font-bold text-rose-800 uppercase tracking-widest flex items-center gap-2">
                  <div className="p-1.5 rounded bg-rose-50 text-[#B30447]"><MapPin className="h-4 w-4" /></div>
                  City
                </label>
            ...
            {email !== "Not Provided" && (
              <div className="space-y-2">
                <label className="text-xs font-bold text-rose-800 uppercase tracking-widest flex items-center gap-2">
                  <div className="p-1.5 rounded bg-rose-50 text-[#B30447]"><Mail className="h-4 w-4" /></div>
                 Email Address
                </label>
