        ...
        <form onSubmit={(e) => void submit(e)} className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="block w-full rounded-lg border-2 border-gray-200 px-3 py-3 focus:border-primary focus:outline-none bg-white"
                >
            ...
            <button
              ...
              className="mt-6 w-full rounded-xl bg-primary px-4 py-3.5 text-base font-bold text-white shadow hover:bg-primary-dark focus:outline-none focus:ring-4 focus:ring-blue-200 disabled:opacity-50 transition"
            >
