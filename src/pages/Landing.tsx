...
export default function Landing() {
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      {/* Navbar */}
      <header className="sticky top-0 z-50 shadow-md bg-[#B30447]">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-[#B30447] py-20 lg:py-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="animate-in fade-in slide-in-from-bottom-5 duration-1000 mx-auto mt-6 max-w-2xl text-lg text-rose-100 sm:text-xl">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-6 duration-1000 mt-10 flex justify-center gap-4">
            <Link
              to="/visitor/events"
              className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 text-base font-bold text-[#B30447] shadow-xl transition-transform hover:scale-105"
            >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="group rounded-3xl bg-white p-8 text-center shadow-lg shadow-gray-200/50 border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              <div className="mx-auto mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-rose-50 text-[#B30447] group-hover:bg-[#B30447] group-hover:text-white transition-colors duration-300">
