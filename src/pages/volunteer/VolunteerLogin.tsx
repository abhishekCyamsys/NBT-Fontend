    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-4 py-10 sm:px-6">
      <div className="mx-auto w-full max-w-md">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-4 flex items-center justify-center rounded-2xl bg-[#334383] px-6 py-5 shadow-lg">
        ...
        <div className="rounded-2xl bg-white p-6 shadow-2xl">
          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#334383] transition"
            ...
            <button
              disabled={loading}
              className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-[#334383] px-4 py-3 font-semibold text-white shadow-lg transition hover:bg-[#263262] disabled:opacity-50"
              type="submit"
            >
