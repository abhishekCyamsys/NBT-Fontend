        ...
        <div className="rounded-2xl bg-white p-6 shadow-xl">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <select
                  ...
                  className="block w-full rounded-lg border-2 border-gray-200 bg-white px-3 py-3 focus:border-primary focus:outline-none"
                  required
                >
            ...
            <button
              ...
              className="w-full rounded-lg bg-primary px-4 py-3.5 text-base font-bold text-white shadow-lg transition hover:bg-primary-dark disabled:opacity-50"
            >
